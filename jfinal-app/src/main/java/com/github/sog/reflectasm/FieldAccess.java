...
public abstract class FieldAccess {
	...
	static public FieldAccess get (Class type) {
		...
		synchronized (loader) {
			try {
				...
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "com/github/sog/reflectasm/FieldAccess",
					null);
	...
	static private void insertConstructor (ClassWriter cw) {
		...
		mv.visitMethodInsn(INVOKESPECIAL, "com/github/sog/reflectasm/FieldAccess", "<init>", "()V");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}
