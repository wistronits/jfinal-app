...
public class ConvertBean {
     ...
     */
    public DateTime toJDateTime(Object value) {
        return (DateTime) typeConverters[27].convert(value);
    }
     ...
     * when conversion result is <code>null</code>
     */
    public DateTime toJDateTime(Object value, DateTime defaultValue) {
        DateTime result = (DateTime) typeConverters[27].convert(value);
        if (result == null) {
            return defaultValue;
        }
        return result;
