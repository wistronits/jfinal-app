...
public class Db {
    ...
    /**
     * @see #query(javax.sql.DataSource, String, Object...)
     */
    ...
    /**
     * @param sql an SQL statement
     * @see #update(javax.sql.DataSource, String, Object...)
     */
    ...
    /**
     * @see #find(javax.sql.DataSource, String, Object...)
     */
    ...
    public static Record findById(String tableName, Object idValue) {
        return findById(tableName, PRIMARY_KEY, idValue, COLUMNS);
    }
    ...
    public static Record findById(String tableName, String primaryKey, Number idValue) {
        return findById(tableName, primaryKey, idValue, COLUMNS);
    }
    ...
    public static boolean deleteById(String tableName, Object id) {
        return deleteById(tableName, PRIMARY_KEY, id);
    }
    ...
    public static boolean delete(String tableName, Record record) {
        return deleteById(tableName, PRIMARY_KEY, record.get(PRIMARY_KEY));
    }
    ...
    /**
     * @see #paginate(javax.sql.DataSource, int, int, String, String, Object...)
     */
    ...
    /**
     * @see #save(javax.sql.DataSource, String, String, com.jfinal.plugin.activerecord.Record)
     */
    ...
    public static boolean save(String tableName, Record record) {
        return save(tableName, PRIMARY_KEY, record);
    }
    ...
    public static boolean save(DataSource dataSource, String tableName, Record record) {
        return save(dataSource, tableName, PRIMARY_KEY, record);
    }
    ...
    static boolean update(Connection conn, String tableName, String primaryKey, Record record) throws SQLException {
        ...
        return paras.size() > 1 && update(conn, sql.toString(), paras.toArray()) >= 1;

    }

    /**
     * @see #update(javax.sql.DataSource, String, String, com.jfinal.plugin.activerecord.Record)
     */
    ...
    public static boolean update(String tableName, Record record) {
        return update(tableName, PRIMARY_KEY, record);
    }
    ...
    public static boolean update(DataSource dataSource, String tableName, Record record) {
        return update(dataSource, tableName, PRIMARY_KEY, record);
    }

    /**
     * @see #execute(javax.sql.DataSource, com.jfinal.plugin.activerecord.ICallback)
     */
    ...
    /**
     * @param dataSource the DataSource for this query
     * @see #batch(String, String, java.util.List, int)
     */
