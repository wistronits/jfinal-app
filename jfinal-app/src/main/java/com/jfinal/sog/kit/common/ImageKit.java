...
public final class ImageKit {
     ...
     */
    public ImageKit add(File file, int position) {
        Image src;
        try {
    ...
    public ImageKit resizeBy(int w, int h) {
     ...
     * @see #resizeTo(int, int)
     */
    public ImageKit resizeBy(int w, int h, Color c) {
     ...
     * @see #resizeBy(int, int, java.awt.Color)
     */
    public ImageKit resizeTo(int w, int h) {
        if (w == width && h == height) return this;
