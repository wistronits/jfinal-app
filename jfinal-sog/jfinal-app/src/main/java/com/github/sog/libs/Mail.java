...
public class Mail {
    ...
    public static Future<Boolean> send(Email email) {
        try {
            ...
            if (JFinalApp.configuration.getProperty("mail.smtp", "").equals("mock") && JFinalApp.mode == JFinalApp.Mode.DEV) {
                Mock.send(email);
    ...
    public static Email buildMessage(Email email) throws EmailException {
        ...
        String from = JFinalApp.configuration.getProperty("mail.smtp.from");
    ...
    public static Session getSession() {
        if (session == null) {
            ...
            props.put("mail.smtp.host", JFinalApp.configuration.getProperty("mail.smtp.host", "localhost"));

            String channelEncryption;
            if (JFinalApp.configuration.containsKey("mail.smtp.protocol") && JFinalApp.configuration.getProperty("mail.smtp.protocol", "smtp").equals("smtps")) {
                // Backward compatibility before stable5
                channelEncryption = "starttls";
            } else {
                channelEncryption = JFinalApp.configuration.getProperty("mail.smtp.channel", "clear");
            }
            ...
            if (JFinalApp.configuration.containsKey("mail.smtp.localhost")) {
                props.put("mail.smtp.localhost", JFinalApp.configuration.get("mail.smtp.localhost"));            //override defaults
            }
            if (JFinalApp.configuration.containsKey("mail.smtp.socketFactory.class")) {
                props.put("mail.smtp.socketFactory.class", JFinalApp.configuration.get("mail.smtp.socketFactory.class"));
            }
            if (JFinalApp.configuration.containsKey("mail.smtp.port")) {
                props.put("mail.smtp.port", JFinalApp.configuration.get("mail.smtp.port"));
            }
            String user = JFinalApp.configuration.getProperty("mail.smtp.user");
            String password = JFinalApp.configuration.getProperty("mail.smtp.pass");
            if (password == null) {
                // Fallback to old convention
                password = JFinalApp.configuration.getProperty("mail.smtp.password");
            }
            session = null;
            ...
            if (Boolean.parseBoolean(JFinalApp.configuration.getProperty("mail.debug", "false"))) {
